...
$lang = array_merge($lang, [
	...
	'RADIOGLOBE_LOCATE'				=> 'Vicino a me',
	'RADIOGLOBE_LOCATE_TITLE'		=> 'Porta il globo nella tua città e mostra le stazioni più vicine',
	'RADIOGLOBE_LOCATE_DENIED'		=> 'Posizione non disponibile: il browser non ha il permesso. Puoi darlo dall’icona accanto all’indirizzo della pagina.',
	'RADIOGLOBE_LOCATE_FAILED'		=> 'Non è stato possibile trovare la tua posizione. Riprova tra poco.',
	'RADIOGLOBE_LOCATE_ACCURACY'	=> 'Posizione indicata dal browser, precisa a circa %s.',
	'RADIOGLOBE_LOCATE_POOR'		=> 'Non è una lettura del GPS: il browser l’ha ricavata dalla rete o dall’indirizzo internet, quindi può indicare la città del tuo provider invece della tua. Succede quasi sempre sui computer fissi.',
	'RADIOGLOBE_LOCATE_SAVE'		=> 'Usa come mia posizione',
	'RADIOGLOBE_LOCATE_SAVED_OK'	=> 'Posizione salvata: «Vicino a me» userà questa, anche senza GPS.',
	'RADIOGLOBE_LOCATE_SAVED_IN_USE'	=> 'Stai usando la posizione che hai salvato.',
	'RADIOGLOBE_LOCATE_AGAIN'		=> 'Rileva di nuovo',
	'RADIOGLOBE_LOCATE_USE_PLACE'	=> 'Usa questo luogo come mia posizione',
	'RADIOGLOBE_REMOVE_STATION'		=> 'Togli questa stazione dall’elenco',
	'RADIOGLOBE_REMOVE_STATION_ASK'	=> 'Togliere «%s» dall’elenco del forum? Sparisce per tutti, ma torna al prossimo aggiornamento delle stazioni dall’ACP.',
	'RADIOGLOBE_REMOVED_STATION'	=> 'Stazione tolta dall’elenco: %s',
	'RADIOGLOBE_LOCATE_WRONG'		=> 'Non è la mia città',
	'RADIOGLOBE_LOCATE_WRONG_HELP'	=> 'Scrivi qui sopra la tua città (per esempio «Scandicci»), clicca una delle sue stazioni e poi premi il segnaposto accanto al pulsante di riproduzione: da quel momento «Vicino a me» userà sempre quel luogo, anche senza GPS.',
	...
	'RADIOGLOBE_CITY_SOURCE'		=> 'Città: GeoNames (CC BY 4.0)',
